 ...
 * @date : 上午 11:14 19/9/2020
 */
public class QiNiuUtils {
    private static final String ACCESSKEY = "d5FdkDHEIBvNSixaeSzDhjhDgF_ubqWuYt0xCfFH";
    private static final String SECRETKEY = "2nmuhuMi0IPRWHYKCcdIn9pxptTNMpPr-1t-8qvB";
    private static final String BUCKET = "star-0014";
    public static final String DOMAIN= "http://qgvw38xd6.hd-bkt.clouddn.com/";

    public static void main(String[] args) {
        uploadFile("E:\\a\\timg.jpg","star.jpg");
